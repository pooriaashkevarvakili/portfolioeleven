...
export const TeamCatalogItem: React.FunctionComponent<AppProps> = ({
 teamCatalogItem,teamCatalogHeader,teamCatalogSocial, teamCatalogSocialOne
}) => {
                        ...
                        <div className="team wow fadeIn">
                            ...
                            <div className="team-overlay text-center">
                                  ...
                                  <ul
                                    ...
                                    <li><a href={teamCatalogSocial.ShortDescription} target="_blank"><i className="fa fa-whatsapp"></i></a></li>

                                    <li><a href={teamCatalogSocial.FirstHeader} target="_blank"><i className="fa fa-instagram"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="team wow fadeIn">
                            ...
                            <div className="team-overlay text-center">
                                ...
                                <ul 
                                      ...
                                      className="social-icons">
                                    <li><a href={teamCatalogSocial.ChildFirstHeader} target="_blank"><i className="fa fa-telegram"></i></a></li>
                                    <li><a href={teamCatalogSocial.ShortDescription} target="_blank"><i className="fa fa-whatsapp"></i></a></li>

                                    <li><a href={teamCatalogSocial.LongDescription} target="_blank"><i className="fa fa-instagram"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
