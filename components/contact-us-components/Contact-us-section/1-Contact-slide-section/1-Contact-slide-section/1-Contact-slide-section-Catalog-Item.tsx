...
// ------------------------------ ---------------------- --------
interface AppProps {
  contactSlideItem: OneCatalogData;
}
export const ContactSlideItem: React.FunctionComponent<AppProps> = ({
  contactSlideItem

}) => {

  const{FirstHeader,SecondHeader,ContentAttachment,ShortDescription}=contactSlideItem
  return (
    <>
